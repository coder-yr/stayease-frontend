...
export default function AdminDashboard() {
  ...
  const handleApprove = async (id: string) => {
    ...
    try {
      ...
      loadPendingHotels(); // Revert on failure
    }
  };
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                    ...
                    <div className="flex gap-2 shrink-0">
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl text-white bg-emerald-500 hover:bg-emerald-600 shadow-lg shadow-emerald-500/20 text-[10px] font-bold uppercase tracking-widest transition-all hover:-translate-y-0.5"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl text-white bg-rose-500 hover:bg-rose-600 shadow-lg shadow-rose-500/20 text-[10px] font-bold uppercase tracking-widest transition-all hover:-translate-y-0.5"
                      >
