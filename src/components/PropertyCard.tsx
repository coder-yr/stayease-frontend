        ...
        <div className="mt-8 pt-8 border-t border-slate-50 flex items-center justify-between">
          <div className="space-y-1">
            ...
            <div className="text-3xl font-display font-bold text-slate-900 tracking-tighter">
              ₹{(Number(property.price) * (Number(property.price) < 500 ? 84 : 1)).toLocaleString('en-IN')}
              <span className="text-slate-400 text-xs font-serif italic lowercase font-medium ml-2">/night</span><span className="text-[8px] font-bold text-slate-300 uppercase tracking-widest ml-2">(Excl. Taxes)</span>
            </div>
          </div>
